...
const PREFLOP_PROFILE = {
  ...
  "weak-tight": {
    ...
    threeBetFloorShift: 7,
    stealWindow: 4,
    bluffThreeBetWindow: 4,
    defendFloorShift: 4,
    pairBonus: 6,
    suitedAceBonus: 4,
    suitedConnectorBonus: 2,
    weakOffsuitPenalty: 6
  },
  lag: {
    openFloorShift: -7,
    callFloorShift: -4,
  ...
  maniac: {
    openFloorShift: -9,
    callFloorShift: -4,
    threeBetFloorShift: -8,
    stealWindow: 15,
    bluffThreeBetWindow: 12,
    defendFloorShift: -6,
    pairBonus: 9,
    suitedAceBonus: 8,
    suitedConnectorBonus: 9,
    weakOffsuitPenalty: 1
  },
  recreational: {
    openFloorShift: -1,
    callFloorShift: -2,
    threeBetFloorShift: 2,
    stealWindow: 7,
    bluffThreeBetWindow: 5,
    defendFloorShift: -2,
    pairBonus: 7,
    suitedAceBonus: 6,
    suitedConnectorBonus: 6,
...
const POSTFLOP_PROFILE = {
  ...
  "weak-tight": {
    ...
    semiBluffShift: -0.02,
    pressureBias: -0.05,
    barrelThresholdShift: 6,
    probeThresholdShift: 5,
    bluffThresholdShift: 10,
    semiBluffBetShift: 5,
    semiBluffRaiseShift: 7,
    raiseFrequency: 0.08,
  ...
  maniac: {
    ...
    semiBluffShift: 0.13,
    pressureBias: 0.14,
    barrelThresholdShift: -12,
    probeThresholdShift: -12,
    bluffThresholdShift: -10,
    semiBluffBetShift: -12,
    semiBluffRaiseShift: -10,
    raiseFrequency: 0.21,
    semiBluffRaiseFrequency: 0.2,
    sizing: {
      value: [0.62, 1.05],
      cbet: [0.44, 0.78],
      bluff: [0.58, 1.02],
  ...
  recreational: {
    ...
    semiBluffShift: 0.03,
    pressureBias: 0,
    barrelThresholdShift: 2,
    probeThresholdShift: 0,
    bluffThresholdShift: 4,
    semiBluffBetShift: 0,
    semiBluffRaiseShift: 4,
    raiseFrequency: 0.09,
    semiBluffRaiseFrequency: 0.06,
    sizing: {
      value: [0.48, 0.74],
      cbet: [0.34, 0.56],
      bluff: [0.38, 0.62],
